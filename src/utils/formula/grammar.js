...
var grammar = {
    ...
    {"name": "vector_term", "symbols": ["vector_primary"], "postprocess": d => d[0]},
    {"name": "vector_term$macrocall$2", "symbols": ["vector_expression"], "postprocess": d => d[0]},
    {"name": "vector_term$macrocall$1$string$1", "symbols": [{"literal":"d"}, {"literal":"o"}, {"literal":"t"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "vector_term$macrocall$1", "symbols": ["vector_term$macrocall$1$string$1", "vector_term$macrocall$2", {"literal":","}, "vector_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "DOT_FUNCTION", inputs: [d[1], d[3]] })},
    {"name": "vector_term$macrocall$1$string$2", "symbols": [{"literal":"c"}, {"literal":"r"}, {"literal":"o"}, {"literal":"s"}, {"literal":"s"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "vector_term$macrocall$1", "symbols": ["vector_term$macrocall$1$string$2", "vector_term$macrocall$2", {"literal":","}, "vector_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "CROSS_FUNCTION", inputs: [d[1], d[3]] })},
    {"name": "vector_term$macrocall$1$string$3", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"r"}, {"literal":"m"}, {"literal":"a"}, {"literal":"l"}, {"literal":"i"}, {"literal":"z"}, {"literal":"e"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "vector_term$macrocall$1", "symbols": ["vector_term$macrocall$1$string$3", "vector_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "NORMALIZE_FUNCTION", input: d[1] })},
    ...
    {"name": "vector_term$macrocall$5", "symbols": ["vector_primary"], "postprocess": d => d[0]},
    ...
    {"name": "number_term", "symbols": ["number_primary"], "postprocess": d => d[0]},
    {"name": "number_term$macrocall$2", "symbols": ["number_expression"], "postprocess": d => d[0]},
    {"name": "number_term$macrocall$1$string$1", "symbols": [{"literal":"s"}, {"literal":"i"}, {"literal":"n"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "number_term$macrocall$1", "symbols": ["number_term$macrocall$1$string$1", "number_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "SIN_FUNCTION", input: d[1] })},
    {"name": "number_term$macrocall$1$string$2", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"s"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "number_term$macrocall$1", "symbols": ["number_term$macrocall$1$string$2", "number_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "COS_FUNCTION", input: d[1] })},
    {"name": "number_term$macrocall$1$string$3", "symbols": [{"literal":"t"}, {"literal":"a"}, {"literal":"n"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "number_term$macrocall$1", "symbols": ["number_term$macrocall$1$string$3", "number_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "TAN_FUNCTION", input: d[1] })},
    {"name": "number_term$macrocall$1$string$4", "symbols": [{"literal":"a"}, {"literal":"t"}, {"literal":"a"}, {"literal":"n"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "number_term$macrocall$1", "symbols": ["number_term$macrocall$1$string$4", "number_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "ATAN_FUNCTION", input: d[1] })},
    {"name": "number_term$macrocall$1$string$5", "symbols": [{"literal":"a"}, {"literal":"b"}, {"literal":"s"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "number_term$macrocall$1", "symbols": ["number_term$macrocall$1$string$5", "number_term$macrocall$2", {"literal":")"}], "postprocess": d => ({ type: "ABS_FUNCTION", input: d[1] })},
    ...
    {"name": "number_term$macrocall$5", "symbols": ["number_primary"], "postprocess": d => d[0]},
