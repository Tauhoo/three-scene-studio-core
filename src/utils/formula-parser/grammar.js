...
var grammar = {
    ...
    {"name": "vector_expression", "symbols": ["vector_multiplicative"], "postprocess": d => d[0]},
    {"name": "vector_expression$macrocall$2", "symbols": ["vector_expression"], "postprocess": d => d[0]},
    {"name": "vector_expression$macrocall$3", "symbols": ["vector_multiplicative"], "postprocess": d => d[0]},
