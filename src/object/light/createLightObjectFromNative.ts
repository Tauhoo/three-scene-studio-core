...
export function createLightObjectFromNative(
  ...
  if (light instanceof THREE.AmbientLight) {
    const result = new AmbientLightObjectInfo(light, sceneId, objectInfoStorage)
    return result
    ...
    const result = new PointLightObjectInfo(light, sceneId, objectInfoStorage)
    return result
    ...
    const result = new SpotLightObjectInfo(light, sceneId, objectInfoStorage)
    return result
  } else {
